...
export const getLatestSubscription = state => state.subscriptions.get('latest');
export const getSubPoints = state => state.subscriptions.get('subPoints');

export const getStreamStartTime = state => state.uptime.get('startTime');

export const getCurrentSong = state => state.songs.get('currentSong');
export const getQueueSize = state => state.songs.get('queueSize');
